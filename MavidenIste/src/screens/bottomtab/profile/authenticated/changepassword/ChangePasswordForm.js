                ...
                >
                    {({values, handleChange, setFieldTouched, handleSubmit, errors, touched, isSubmitting}) => (
                        <View style={styles.inputFormArea}>
                            ...
                            <View style={styles.inputs}>
                                <Text style={styles.inputInfoArea}>Mevcut şifre tekrarı {(errors.newpassword_verifaction && touched.newpassword_verifaction) && <Text style={{color:'red', fontSize:10}}>{errors.newpassword_verifaction}</Text>}</Text>
                                <Item
                                    style={styles.inputArea}>
                                    <Input
                                        style={[styles.input, {zIndex:9}]}
